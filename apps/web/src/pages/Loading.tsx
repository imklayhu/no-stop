      ...
      <MobileFrame>
        <div className="relative h-full flex flex-col pt-16 px-8 pb-10">
          <div className="relative flex-none h-64 flex items-center justify-center">
            ...
            <div className="absolute w-64 h-64 border border-brand-accent/20 rounded-full animate-ping" style={{ animationDelay: "1s" }}></div>
            <div className="absolute w-64 h-64 border border-brand-accent/20 rounded-full animate-ping" style={{ animationDelay: "2s" }}></div>
            ...
            <div className="relative w-20 h-20 bg-brand-black border-2 border-brand-accent rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(245,158,11,0.3)]">
              <span className="material-symbols-outlined text-brand-accent text-4xl">polyline</span>
            </div>
          </div>
          ...
          <div className="flex-1 mt-10 space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-lg font-bold text-brand-accent">生成候选闭环 (30km ±10%)</span>
            </div>
          ...
          <div className="mt-auto bg-[#020617] rounded-2xl p-4 shadow-inner border border-slate-800/50">
            <div className="h-32 overflow-y-auto font-mono text-xs leading-relaxed text-brand-success space-y-1">
              <p className="flex"><span className="mr-2">&gt;</span> Analysis: urban_loop mode</p>
              <p className="flex"><span className="mr-2">&gt;</span> Target: 30km [tolerance: low]</p>
              <p className="flex"><span className="mr-2">&gt;</span> Constraint: avoid_u_turn = true</p>
              {step >= 1 && (
                <>
                  <p className="flex"><span className="mr-2">&gt;</span> Fetching road network data...</p>
                  <p className="flex"><span className="mr-2">&gt;</span> Generating 12 candidate loops...</p>
                </>
              )}
              {step >= 2 && (
                <p className="flex opacity-80"><span className="mr-2">&gt;</span> Optimizing segments...</p>
              )}
            </div>
          </div>
        </div>
