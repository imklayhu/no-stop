    ...
    <div className="min-h-screen bg-brand-black text-white flex items-center justify-center">
      <MobileFrame>
        ...
        <div className="relative z-10 p-4 pt-4 flex justify-between items-start w-full">
          <button
            className="w-8 h-8 bg-white/90 rounded-full flex items-center justify-center shadow-lg text-slate-800"
            onClick={() => navigate("/")}
          >
          ...
          <div className="flex flex-col items-end gap-2">
            <div className="bg-white/95 rounded-full px-4 py-1.5 flex items-center gap-1 shadow-md">
              ...
              <span className="text-brand-accent flex items-center">
                ...
                <span className="text-slate-900 text-sm font-bold ml-0.5">
                  9.8
                </span>
              </span>
            </div>
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
          <svg
            className="drop-shadow-lg w-3/4 max-w-[80%] h-auto"
            viewBox="0 0 100 100"
          >
            <path
              d="M20 50 L45 35 L70 55"
              fill="none"
              stroke="#F59E0B"
              strokeWidth="4"
              strokeLinecap="round"
        ...
        <div className="mt-auto relative z-10 p-4">
          <div className="bg-brand-black/90 rounded-[2rem] p-6 shadow-2xl flex flex-col gap-6 border border-white/10">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex justify-end gap-8">
                <div className="flex flex-col items-center">
                  <span className="text-brand-gray text-xs font-medium mb-1">
                    红绿灯
                  </span>
            ...
            <div className="flex gap-3 pt-2">
              <button className="flex-[0.8] bg-white/10 hover:bg-white/20 text-white font-bold py-4 px-4 rounded-2xl transition-all">
                下一条
              </button>
              <button
                className="flex-[1.5] bg-brand-accent hover:bg-amber-500 text-brand-black font-bold py-4 px-4 rounded-2xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-brand-accent/20"
